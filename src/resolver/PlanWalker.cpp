...
std::shared_ptr<Table> PlanWalker::walk(const std::shared_ptr<Plan> &plan) {
  switch (plan->type) {
...
std::shared_ptr<Table> PlanWalker::walkQuery(
...
std::shared_ptr<hustle::operators::SelectOperator> PlanWalker::walkSelect(
...
std::shared_ptr<hustle::operators::Join> PlanWalker::walkJoin(
...
std::shared_ptr<hustle::operators::Aggregate> PlanWalker::walkAggregate(
...
std::shared_ptr<hustle::operators::OrderBy> PlanWalker::walkOrderBy(
...
arrow::compute::Datum PlanWalker::walkLiteral(
    const std::shared_ptr<Expr> &expr) {
  switch (expr->type) {
...
arrow::compute::CompareOperator PlanWalker::walkCompareOperator(
...
hustle::operators::AggregateKernels PlanWalker::walkAggFuncType(
